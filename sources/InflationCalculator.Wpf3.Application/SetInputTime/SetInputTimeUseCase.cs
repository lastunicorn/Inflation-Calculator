...
namespace DustInTheWind.InflationCalculator.Wpf3.Application.SetInputTime
{
    public class SetInputTimeUseCase : AsyncRequestHandler<SetInputTimeRequest>
    {
        private readonly Calculator calculator;
        private readonly EventBus eventBus;

        public SetInputTimeUseCase(Calculator calculator, EventBus eventBus)
        {
