...
using DustInTheWind.InflationCalculator.Wpf2.Application.SetInputTime;
using DustInTheWind.InflationCalculator.Wpf2.Application.SetInputValue;
using DustInTheWind.InflationCalculator.Wpf2.Application.SetOutputTime;
using MediatR;
