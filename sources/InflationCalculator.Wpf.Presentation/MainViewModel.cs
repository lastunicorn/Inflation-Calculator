...
using DustInTheWind.InflationCalculator.Wpf.Application.Initialize;
using DustInTheWind.InflationCalculator.Wpf.Application.SetInputTime;
using DustInTheWind.InflationCalculator.Wpf.Application.SetInputValue;
using DustInTheWind.InflationCalculator.Wpf.Application.SetOutputTime;
using MediatR;

namespace DustInTheWind.InflationCalculator.Wpf.Presentation
{
    public class MainViewModel : ViewModelBase
    {
        ...
        private async Task SetInputValue()
        {
            ...
            SetInputValueResponse response = await mediator.Send(request);
        ...
        private async Task SetInputTime()
        {
            ...
            SetInputTimeResponse response = await mediator.Send(request);
        ...
        private async Task SetOutputTime()
        {
            ...
            SetOutputTimeResponse response = await mediator.Send(request);
